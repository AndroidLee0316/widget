...
public class MoreGesturePhotoView extends PhotoView {
    ...
    public MoreGesturePhotoView(Context context, AttributeSet attr) {
        this(context, attr, 0);
    }

    public MoreGesturePhotoView(Context context, AttributeSet attr, int defStyle) {
                            ...
                            public void run() {
                                if (mTranslateX == 0 && mTranslateY == 0 && canFinish) {
                                    ...
                                    if (mTapListener != null) {
                                        mTapListener.onTap(MoreGesturePhotoView.this);
                                    }
                                }
                                canFinish = false;
                            }
    ...
    public interface OnTapListener {
        void onTap(MoreGesturePhotoView view);
    }

    public interface OnExitListener {
        void onExit(MoreGesturePhotoView view, float translateX, float translateY, float w, float h);
    }
