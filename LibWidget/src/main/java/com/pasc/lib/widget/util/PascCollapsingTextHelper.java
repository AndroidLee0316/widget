...
package com.pasc.lib.widget.util;
...
public final class PascCollapsingTextHelper {
    ...
    public PascCollapsingTextHelper(View view){
        this(view, 0f);
    }

    public PascCollapsingTextHelper(View view, float defaultExpanededFraction) {
        mView = view;
    ...
    public void setCollapsedTextAppearance(int resId) {
        TypedArray a = mView.getContext().obtainStyledAttributes(resId, R.styleable.PascTextAppearance);
        if (a.hasValue(R.styleable.PascTextAppearance_android_textColor)) {
            mCollapsedTextColor = a.getColorStateList(R.styleable.PascTextAppearance_android_textColor);
        }
        if (a.hasValue(R.styleable.PascTextAppearance_android_textSize)) {
            mCollapsedTextSize = a.getDimensionPixelSize(R.styleable.PascTextAppearance_android_textSize,
                    (int) mCollapsedTextSize);
        }
        mCollapsedShadowColor = a.getInt(R.styleable.PascTextAppearance_android_shadowColor, 0);
        mCollapsedShadowDx = a.getFloat(R.styleable.PascTextAppearance_android_shadowDx, 0);
        mCollapsedShadowDy = a.getFloat(R.styleable.PascTextAppearance_android_shadowDy, 0);
        mCollapsedShadowRadius = a.getFloat(R.styleable.PascTextAppearance_android_shadowRadius, 0);
        a.recycle();
    ...
    public void setExpandedTextAppearance(int resId) {
        TypedArray a = mView.getContext().obtainStyledAttributes(resId, R.styleable.PascTextAppearance);
        if (a.hasValue(R.styleable.PascTextAppearance_android_textColor)) {
            mExpandedTextColor = a.getColorStateList(R.styleable.PascTextAppearance_android_textColor);
        }
        if (a.hasValue(R.styleable.PascTextAppearance_android_textSize)) {
            mExpandedTextSize = a.getDimensionPixelSize(R.styleable.PascTextAppearance_android_textSize,
                    (int) mExpandedTextSize);
        }
        mExpandedShadowColor = a.getInt(
                R.styleable.PascTextAppearance_android_shadowColor, 0);
        mExpandedShadowDx = a.getFloat(
                R.styleable.PascTextAppearance_android_shadowDx, 0);
        mExpandedShadowDy = a.getFloat(
                R.styleable.PascTextAppearance_android_shadowDy, 0);
        mExpandedShadowRadius = a.getFloat(
                R.styleable.PascTextAppearance_android_shadowRadius, 0);
        a.recycle();
    ...
    private void calculateOffsets(final float fraction) {
        ...
        if (mCollapsedTextColor != mExpandedTextColor) {
            ...
            // fraction
            mTextPaint.setColor(PascColorHelper.computeColor(
        ...
        mTextPaint.setShadowLayer(
                ...
                PascColorHelper.computeColor(mExpandedShadowColor, mCollapsedShadowColor, fraction));
