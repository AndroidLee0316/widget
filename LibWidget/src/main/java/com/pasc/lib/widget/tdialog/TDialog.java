...
public class TDialog extends BaseDialogFragment {
    ...
    public TDialog show() {
        ...
        //PascLog.d(BaseDialogFragment.TAG, "show");
    ...
    public static class Builder {
        ...
        public Builder setScreenWidthAspect(Activity activity, float widthAspect) {
            params.mWidth = (int) (BaseDialogFragment.getWindowWidth(activity) * widthAspect);
            return this;
        }
        ...
        public Builder setScreenHeightAspect(Activity activity, float heightAspect) {
            params.mHeight = (int) (BaseDialogFragment.getWindowHeight(activity) * heightAspect);
            return this;
        }
        ...
        public TDialog create() {
            ...
            //PascLog.d(BaseDialogFragment.TAG, "create");
