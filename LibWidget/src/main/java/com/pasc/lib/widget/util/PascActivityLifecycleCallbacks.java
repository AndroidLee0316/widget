...
public abstract class PascActivityLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {

    private final Activity mTargetActivity;

    public PascActivityLifecycleCallbacks(Activity targetActivity) {
