 ...
 * Modified by chenruihan410 on 2018/7/12. 修改去掉依赖ButterKnife的代码。
 */
public class CallCarView extends RelativeLayout implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        tvCallCar = view.findViewById(R.id.tv_call_car);
        viewRoute = view.findViewById(R.id.rl_route);
        ivEditRoute = view.findViewById(R.id.iv_edit_route);
        tvRoute = view.findViewById(R.id.tv_route);
        btnCancelCar = view.findViewById(R.id.btn_cancel_car);
