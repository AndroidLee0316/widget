...
import com.pasc.lib.widget.refreshlayout.api.DefaultRefreshFooterCreater;
import com.pasc.lib.widget.refreshlayout.api.DefaultRefreshHeaderCreater;
import com.pasc.lib.widget.refreshlayout.api.RefreshContent;
...
import com.pasc.lib.widget.refreshlayout.api.ScrollBoundaryDecider;
...
import com.pasc.lib.widget.refreshlayout.impl.RefreshContentWrapper;
import com.pasc.lib.widget.refreshlayout.impl.RefreshFooterWrapper;
import com.pasc.lib.widget.refreshlayout.impl.RefreshHeaderWrapper;
import com.pasc.lib.widget.refreshlayout.listener.OnLoadmoreListener;
import com.pasc.lib.widget.refreshlayout.listener.OnMultiPurposeListener;
import com.pasc.lib.widget.refreshlayout.listener.OnRefreshListener;
import com.pasc.lib.widget.refreshlayout.listener.OnRefreshLoadmoreListener;
import com.pasc.lib.widget.refreshlayout.util.DelayedRunable;
import com.pasc.lib.widget.refreshlayout.util.DensityUtil;
import com.pasc.lib.widget.refreshlayout.util.ViscousFluidInterpolator;
...
import static com.pasc.lib.widget.refreshlayout.util.DensityUtil.dp2px;
 ...
 * 此类不在维护，在这个PaSwipeRefreshLayout控件做维护
 */
...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    /**
     * 正在刷新时停留的位置, 默认为mHeaderHeight
     */
    protected int mRefreshHeightPx;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mRefreshHeightPx = ta.getDimensionPixelOffset(R.styleable.SmartRefreshLayout_srlHeaderHeight, density.dip2px(100));
    ...
    protected void setStateRefresing() {
        ...
        ValueAnimator animator = animSpinner(mRefreshHeightPx);
        if (animator != null && animator == reboundAnimator) {
            animator.addListener(listener);
        } else {
            listener.onAnimationEnd(null);
    ...
    public ValueAnimator animSpinner(int endSpinner, int startDelay) {
     ...
     * 执行回弹动画
     */
    public ValueAnimator animSpinner(int endSpinner, int startDelay, Interpolator interpolator) {
...
//        }
    ...
    public int getRefreshHeightPx() {
        return mRefreshHeightPx;
    }

    public void setRefreshHeightPx(int refreshHeightPx) {
        this.mRefreshHeightPx = refreshHeightPx;
    }
    ...
    public static class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshKernel setState(@NonNull RefreshState state) {
            switch (state) {
                ...
                case Refreshing:
                    layout.setStateRefresing();
                    break;
                case Loading:
                    layout.setStateLoding();
                    break;
                case RefreshFinish:
                    layout.setStateRefresingFinish();
                    break;
                case LoadFinish:
                    layout.setStateLodingFinish();
                    break;
            }
            return null;
        }
