...
public class FooterView extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mLayoutEndLoading = view.findViewById(R.id.layout_new_footer_no_more);
        mLayoutLoading = view.findViewById(R.id.layout_new_footer);
        mTvEndLoading = view.findViewById(R.id.tv_new_footer_tips);
    }
