...
public class NumberPicker extends LinearLayout {
     ...
     */
    private final int mMinWidth = 64;

    /**
     * The max width of this widget.
     */
    private int mMaxWidth = 180;
...
//    private final Drawable mSelectionDivider;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int layoutResId = R.layout.picker_with_selector_wheel;
...
//            mSelectionDivider = getResources().getDrawable(R.drawable.np_numberpicker_selection_divider, null);
//        } else {
...
//        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mVirtualButtonPressedDrawable = getResources().getDrawable(R.drawable.item_background_holo_dark, null);
        } else {
            mVirtualButtonPressedDrawable = getResources().getDrawable(R.drawable.item_background_holo_dark);
        }
        ...
        // input text
        mInputText = (EditText) findViewById(R.id.piac_numberpicker_input);
        ...
        mSelectionDividerPaint.setColor(context.getResources().getColor(R.color.pasc_primary));
        mSelectionDividerPaint.setStrokeWidth(context.getResources().getDimension(R.dimen.picker_line_height));
...
//            float currentTextSize = getResources().getDimensionPixelSize(R.dimen.picker_un_text_size);
//            float clip = Math.abs(currentY - getHeight() / 2);
////            float elementHeight = mSelectorElementHeight * 2f;
//            float scal = 0.0f;
//            if (clip == 0) {
////                scal = Math.abs(textScale - ((clip * textScale) / elementHeight));
//                currentTextSize = getResources().getDimensionPixelSize(R.dimen.picker_text_size);
//            }
...
//            int color = Color.argb(0xff, 0x00, 0x00, 0x00);
            int color =getResources().getColor(R.color.pasc_primary_text);
...
//        }
        ...
        int topOfTopDivider = mTopSelectionDividerTop;
        canvas.drawLine(0, topOfTopDivider, getRight(), topOfTopDivider, mSelectionDividerPaint);

        int bottomOfBottomDivider = mBottomSelectionDividerBottom;
        canvas.drawLine(0, bottomOfBottomDivider, getRight(), bottomOfBottomDivider, mSelectionDividerPaint);
    }
    ...
    private void ensureCachedScrollSelectorValue(int selectorIndex) {
        ...
        if (selectorIndex < mMinValue || selectorIndex > mMaxValue) {
            ...
            if (mDisplayedValues != null) {
                ...
                if(mDisplayedValues.length > displayedValueIndex){
    ...
    private boolean updateInputTextView() {
        ...
        if(mDisplayedValues == null){
            ...
            if(mDisplayedValues.length > (mValue - mMinValue)){
                if((mValue - mMinValue) >=0 ){
...
//			setBackgroundColor(R.color.tws_light);
    ...
    public void setSlowScroller(boolean slowScroller) {
        mSlowScroller = slowScroller;
    }
