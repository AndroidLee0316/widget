...
public class PascDrawableHelper {
    private static final String TAG = PascDrawableHelper.class.getSimpleName();
    ...
    public static Bitmap createBitmapFromView(View view, int leftCrop, int topCrop, int rightCrop, int bottomCrop) {
        Bitmap originBitmap = PascDrawableHelper.createBitmapFromView(view);
...
//            QMUILog.d(TAG, "Error in getVectorDrawable. resVector=" + resVector + ", resName=" + context.getResources().getResourceName(resVector) + e.getMessage());
     ...
     * 生成Color选择器
     */
    public static ColorStateList buildColorStateList(int normalColor, int selectColor) {
        int[][] states = new int[][]{
