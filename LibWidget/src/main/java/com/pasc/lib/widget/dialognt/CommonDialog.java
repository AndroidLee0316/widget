...
public class CommonDialog extends Dialog {
    ...
    private void initView() {
        ...
        switch (type) {
            case Common_Center:
                ...
                params.leftMargin = DensityUtils.dp2px(100) / 2;
                params.rightMargin = DensityUtils.dp2px(100) / 2;
    ...
    private void initCommonBottom() {
        cornerSize = DensityUtils.dp2px(3);
        //设置内容，如果没有设置值，就不显示
        if (content == null || TextUtils.isEmpty(content)) {
            tvContent.setVisibility(View.GONE);
            vDivider1.setVisibility(View.GONE);
            tvButton1.getDelegate().setCornerRadius_TL(cornerSize);
            tvButton1.getDelegate().setCornerRadius_TR(cornerSize);
        } else {
