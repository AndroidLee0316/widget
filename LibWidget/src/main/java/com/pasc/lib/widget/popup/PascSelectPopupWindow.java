...
import com.pasc.lib.widget.RecycleViewSpace;
...
public class PascSelectPopupWindow extends PopupWindow {
    ...
    public PascSelectPopupWindow(Activity context, int width, RecyclerView.Adapter adapter,
    ...
    private void initView() {
        ...
        rvSelectPop = popupWindowView.findViewById(R.id.rv_select_pop);
    ...
    public void setLayoutManager(RecyclerView.LayoutManager layoutManager, int decoration, int colorId) {
        ...
        rvSelectPop.setBackgroundColor(mActivity.getResources().getColor(R.color.white));
    ...
    public PascSelectPopupWindow(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
