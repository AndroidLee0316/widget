...
import com.pasc.lib.widget.pickerview.listener.CustomListener;
import com.pasc.lib.widget.pickerview.view.BasePickerView;
import com.pasc.lib.widget.pickerview.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public static class Builder {
        private int layoutRes = R.layout.widget_pickerview_options;
        private CustomListener customListener;
        ...
        // 条目间距倍数 默认1.6
        private float lineSpacingMultiplier = 2.6F;
        private boolean isDialog;//是否是对话框模式
